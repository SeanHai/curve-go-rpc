...
## common.proto
protoc --go_out=. --proto_path=external/_curve \
...
## cli2.proto
protoc --go_out=. --proto_path=external/_curve \
    --go_opt=Mproto/common.proto=github.com/SeanHai/curve-go-rpc/proto/common \
...
protoc --go_out=. --proto_path=external/_curve \
    --go_opt=Mproto/common.proto=github.com/SeanHai/curve-go-rpc/proto/common \
    --go_opt=Mproto/scan.proto=github.com/SeanHai/curve-go-rpc/proto/scan \
...
## statuscode.proto
protoc --go_out=. --proto_path=external/_curve/tools-v2 \
    external/_curve/tools-v2/internal/proto/curvebs/topology/statuscode.proto

protoc --go-grpc_out=. --proto_path=external/_curve \
